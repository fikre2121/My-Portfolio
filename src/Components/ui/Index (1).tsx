...
import { ArrowRight, Code2, Palette, Search, Megaphone, Sparkles } from "lucide-react";
import Layout from "../site/Layout";
import portrait from "../../assets/hero-portrait.png";
import { projects } from "../../data/projects";

const services = [
  { icon: Palette, title: "Web Design", desc: "Calm, considered interfaces with editorial polish.", count: "120 Projects" },
  { icon: Code2, title: "Development", desc: "Production-grade React, TypeScript, performance-first.", count: "241 Projects" },
  { icon: Search, title: "UX Research", desc: "Lightweight discovery that ships, not shelves.", count: "240 Projects" },
  { icon: Megaphone, title: "Brand Strategy", desc: "Identities built to age well across every surface.", count: "331 Projects" },
];

const skills = [
  { label: "Figma", value: 95 },
  { label: "React / TypeScript", value: 92 },
  { label: "Webflow", value: 88 },
  { label: "Brand Systems", value: 80 },
];
    ...
    <Layout>
        ...
        <div className="container-page relative grid lg:grid-cols-2 gap-12 items-center py-20 lg:py-28">
          <div className="space-y-6">
            ...
            <h1 className="font-display font-bold text-5xl sm:text-6xl lg:text-7xl leading-[1.05] tracking-tight">
              I'm Jane Cooper, a <span className="text-gradient">Web Designer</span> &amp; Developer.
            </h1>
            <p className="text-lg text-muted-foreground max-w-xl">
              A personal portfolio is a curated collection of work, achievements,
              and craft. Mine showcases ten years of design and engineering for
            ...
            <div className="flex items-center gap-8 pt-6 border-t border-border mt-6">
              ...
              <div>
                <div className="font-display text-3xl font-bold">240+</div>
                <div className="text-xs uppercase tracking-widest text-muted-foreground">Projects shipped</div>
              </div>
              <div>
                <div className="font-display text-3xl font-bold">98%</div>
                <div className="text-xs uppercase tracking-widest text-muted-foreground">Client retention</div>
              </div>
            </div>
          </div>
          <div className="relative">
            ...
            <div className="relative aspect-square rounded-[2rem] overflow-hidden bg-gradient-primary">
              <div className="absolute inset-0 flex items-end justify-center">
                <span className="font-display text-[7rem] lg:text-[10rem] font-bold text-primary-foreground/20 leading-none mb-[-1rem]">CRAFT</span>
              </div>
              <img
                src={portrait}
      ...
      <section className="container-page py-24">
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-primary">What I Do</p>
            <h2 className="mt-3 font-display text-4xl md:text-5xl font-bold">
              Inspiring the world, <br /> one project at a time.
            </h2>
          </div>
          <p className="text-muted-foreground md:self-end">
            From the first sketch to the last deploy — strategy, design, and engineering
            wrapped in one tight feedback loop. Here's what I help teams ship.
          </p>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((s) => (
            ...
            >
              ...
              <div className="mt-6 pt-6 border-t border-border text-xs font-semibold uppercase tracking-widest text-primary">{s.count}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-secondary/40 border-y border-border">
        <div className="container-page py-24 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-primary">Toolkit</p>
            <h2 className="mt-3 font-display text-4xl md:text-5xl font-bold">
              Empowering creativity through craft.
            </h2>
            <p className="mt-4 text-muted-foreground max-w-md">
              A decade of practice across design and engineering. Here's where I'm sharpest —
              and what I'm always quietly improving.
            </p>
          </div>
          <div className="space-y-6">
            {skills.map((s) => (
      ...
      <section className="container-page py-24">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-primary">Latest Portfolio</p>
            ...
            >
              ...
              <div className="p-7 flex items-start justify-between gap-4">
                <div>
                  ...
                  <h3 className="font-display text-2xl font-bold mt-2 group-hover:text-primary transition">{p.title}</h3>
                </div>
      ...
      <section className="border-y border-border bg-secondary/40">
        <div className="container-page py-12 flex flex-wrap items-center justify-around gap-8">
          {clients.map((c) => (
            <span key={c} className="font-display text-2xl font-bold text-muted-foreground/70 hover:text-primary transition">{c}</span>
          ))}
        </div>
      </section>
